...
# Making APPS
you can make apps based on the "window App" or even the stock apps,
go in "Store/User Made Apps" and read the README.md to see the rules
# Repo structure
- Apps:where the stock Alone OS apps go
- Base-For-Apps:the base for apps "the window app" is in this folder with its window too,you can modify it and make your own app
- Desktop:here go the desktop environments of Alone OS
- F.SH Ports:here go the required ports for the F.SH app in the store
...
# Current Release = 10.1 Cut Lemon
